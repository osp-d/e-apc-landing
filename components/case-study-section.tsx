...
import { ScrollAnimation, SlideIn } from '@/components/scroll-animation';
            ...
            <Card>
              <CardContent className='p-8'>
                <h3 className='mb-6 text-2xl font-bold'>
                  Школа №123, Туркестанская область
                </h3>
                    ...
                    <div>
                      ...
                      <ul className='space-y-2 text-sm text-muted-foreground'>
                        ...
                        <li className='flex gap-2'>
                          <span>•</span>
                          <span>
                            Онлайн-отчёты по посещаемости и библиотеке
                          </span>
                        </li>
                      </ul>
                    </div>
                ...
                <div className='rounded-lg bg-primary/5 p-6'>
                  ...
                  <p className='mb-2 italic text-muted-foreground'>
                    «Система позволила сделать школьный процесс прозрачным и
                    удобным для всех участников»
                  </p>
