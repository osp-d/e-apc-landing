    ...
    <section id="integrations" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-4 text-balance text-center text-3xl font-bold md:text-4xl">Интеграции</h2>
            ...
            {integrations.map((integration) => (
              <Card key={integration.name}>
                <CardContent className="p-6">
                  ...
                  <p className="ml-7 text-sm text-muted-foreground">{integration.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <Card className="bg-primary/5">
            <CardContent className="p-8">
              <h3 className="mb-6 text-xl font-bold">Что это даёт школам и акиматам:</h3>
