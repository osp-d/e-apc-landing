      ...
      <div className='container mx-auto px-4'>
        <div className='mx-auto max-w-4xl text-center'>
          <motion.h1
            ...
            className='mb-6 text-balance text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl'
          >
          ...
          >
            Электронная столовая, СКУД/посещаемость и электронная библиотека — в
            одном решении. Родительский контроль, отчёты, push-уведомления и
            интеграция с ключевыми гос- и финтех-системами.
          </motion.p>
