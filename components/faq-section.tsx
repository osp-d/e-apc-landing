    ...
    <section id="faq" className="bg-muted/30 py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl">
          <h2 className="mb-4 text-balance text-center text-3xl font-bold md:text-4xl">Часто задаваемые вопросы</h2>
          <p className="mb-12 text-center text-muted-foreground">Ответы на популярные вопросы о платформе E-APC</p>
