...
const steps = [
  {
    ...
    description: "Оставьте заявку, и мы проведём анализ потребностей вашей школы",
  },
  {
    icon: Settings,
    number: "2",
    title: "Установка оборудования и обучение персонала",
    description: "Наши специалисты установят систему и обучат ваших сотрудников",
  },
  {
    icon: Rocket,
    number: "3",
    ...
    <section id="connect" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-4 text-balance text-center text-3xl font-bold md:text-4xl">Как подключиться</h2>
          <p className="mb-12 text-center text-muted-foreground">Простой процесс внедрения за 3 шага</p>
          ...
          <Card className="bg-primary/5">
            <CardContent className="p-8 text-center">
              <p className="mb-6 text-lg font-bold">Пилот возможен за 14 дней</p>
